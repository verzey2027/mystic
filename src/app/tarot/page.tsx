...
const spreads = [
  ...
  {
    count: 2,
    title: "2 ใบ — ทางเลือก / เปรียบเทียบ",
    description: "เหมาะกับการชั่งน้ำหนักระหว่างสองทางเลือก ดูข้อดีข้อเสียแต่ละทาง",
    eta: "~ 1 นาที",
    icon: "✦✦",
  },
  {
  ...
  {
    count: 4,
    title: "4 ใบ — แผนปฏิบัติการ",
    description: "วิเคราะห์สถานการณ์ อุปสรรค คำแนะนำ และผลลัพธ์ เพื่อวางแผนอย่างชัดเจน",
    eta: "~ 3 นาที",
    icon: "✦✦✦✦",
  },
  {
